<?php
	...
	if ( function_exists( 'register_nav_menus' ) ) {
	  	register_nav_menus(
	  		array(
	  		  ...
	  		  'doracolblogs-menu' => 'Doracol Blogs Menu',
	...
	define('HEADER_IMAGE_WIDTH', 320); // use width and height appropriate for your theme 1068
	define('HEADER_IMAGE_HEIGHT', 100); // 300
